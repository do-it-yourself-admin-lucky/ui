...
StubbyConfig = {
	["addinfo"] = {
		["Enchantrix"] = "Enchantrix|Display information in item tooltips pertaining to disenchanting, prospecting, and milling results.  [8.2.6428] This AddOn is licensed under the GNU GPL, see GPL.txt for details.",
