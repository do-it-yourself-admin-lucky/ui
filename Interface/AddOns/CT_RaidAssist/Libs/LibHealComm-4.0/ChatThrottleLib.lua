...
--					      --
-- ChatThrottleLib is credited to Mikk        --
-- Its integration to CTRA was by Dahk Celes  --
------------------------------------------------

local module = select(2, ...);

function module:InstallLibHealComm_ChatThrottle()
	if (module:getOption("CTRAFrames_ShareClassicHealPrediction") == false) then return; end

--------------------------------------------------------------
-- Everything below this line is ChatThrottleLib unmodified --
--------------------------------------------------------------
...
--------------------------------------------------------------
-- Everything above this line is ChatThrottleLib unmodified --
--------------------------------------------------------------
