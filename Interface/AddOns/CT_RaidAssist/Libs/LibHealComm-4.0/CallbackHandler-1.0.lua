...
-- to share healing info with raid peers.     --
--					      --
-- CallbackHandler is credited to nevcairiel  --
-- Its integration to CTRA was by Dahk Celes  --
------------------------------------------------

local module = select(2, ...);

function module:InstallLibHealComm_CallbackHandler()
	if (module:getOption("CTRAFrames_ShareClassicHealPrediction") == false) then return; end

--------------------------------------------------------------
-- Everything below this line is CallbackHandler unmodified --
--------------------------------------------------------------
...
--------------------------------------------------------------
-- Everything above this line is CallbackHandler unmodified --
--------------------------------------------------------------
