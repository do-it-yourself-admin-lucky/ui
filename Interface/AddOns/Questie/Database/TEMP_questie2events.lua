TEMP_Questie2Events = {
  ...
  ["Protect Daphne Stilwell"] = {
    ["locations"] = {
      [1] = {49.0, 0.4215, 0.8844, 100.0}
    },
    ["locationCount"] = 1
  },
  ["Go to the Mor'shan Rampart in the Barrens."] = {
    ["locations"] = {
  ...
  ["Find where Gol'dir is being held"] = {
    ["locations"] = {
  ...
  ["Go to the bank in Darnassus, otherwise known as the Bough of the Eternals."] = {
    ["locations"] = {
  ...
  ["Go to the docks of Ratchet in the Barrens."] = {
    ["locations"] = {
  ...
  ["Learn the purpose of the Stone Watcher of Norgannon"] = {
    ["locations"] = {
      [1] = {8.0, 0.3766, 0.8142, 100.0}
    },
    ["locationCount"] = 1
  },
  ["Sentry Point explored"] = {
    ["locations"] = {
  ...
  ["Answer Parqual Fintallas' question correctly"] = {
    ["locations"] = {
  ...
  ["Create the Scepter of Celebras"] = {
    ["locations"] = {
      [1] = {4.0, 0.3597, 0.6441, 100.0}
    },
    ["locationCount"] = 1
  },
  ["Master Kariel Winthalus Found"] = {
    ["locations"] = {
  ...
  ["Answer Braug Dimspirit's question correctly"] = {
    ["locations"] = {
  ...
  ["Help Willix the Importer escape from Razorfen Kraul"] = {
    ["locations"] = {
  ...
  ["Go to the top of the Stonewrought Dam in Loch Modan."] = {
    ["locations"] = {
  ...
  ["Test the Eggscilliscope Prototype"] = {
    ["locations"] = {
  ...
  ["Information Gathered from Kharan"] = {
    ["locations"] = {
  ...
  ["Learn what lore that the stone watcher has to offer"] = {
    ["locations"] = {
  ...
  ["Escort Gilthares Firebough back to Ratchet"] = {
    ["locations"] = {
  ...
  ["Escort Gizelton Caravan past Kolkar Centaur Village"] = {
    ["locations"] = {
