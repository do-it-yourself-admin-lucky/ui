QuestieLocale.locale['esMX'] = {
    ...
    ['ENABLE_DUNGEON_QUEST_ICONS'] = "Habilitar iconos de misiones de calabozos",
    ['ENABLE_DUNGEON_QUEST_ICONS_DESC'] = "Si está marcado, la localización de misiones de calabozos mostrará en el mapa y minimapa.",
    ...
    ['TRACKER_HIDE_IN_COMBAT'] = "Minimizar rastreador en combate",
    ['TRACKER_HIDE_IN_COMBAT_DESC'] = "Si está marcado, el rastreador se minimizará automáticamente al entrar en combate.",
