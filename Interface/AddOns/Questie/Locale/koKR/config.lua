QuestieLocale.locale['koKR'] = {
    ...
    ['TRACKER_SHOW_QUEST_COUNTER'] = "퀘스트 카운터 표시",
    ['TRACKER_SHOW_QUEST_COUNTER_DESC'] = "체크하면 수행 중인 퀘스트의 총 갯수를 추척기 위에 표시합니다.",
    ['TRACKER_SHOW_BLIZZARD_QUEST_TIMER'] = "블리자드 퀘스트 타이머 표시",
    ['TRACKER_SHOW_BLIZZARD_QUEST_TIMER_DESC'] = "체크하면, 퀘스트의 기본 타이머를 표시합니다.",
