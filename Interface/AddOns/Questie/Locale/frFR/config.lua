QuestieLocale.locale['frFR'] = {
    ...
    ['TRACKER_SHOW_QUEST_COUNTER'] = "Afficher le compteur de quêtes",
    ['TRACKER_SHOW_QUEST_COUNTER_DESC'] = "Active l'affichage du nombre de quêtes en cours au dessus du suivi.",
    ['TRACKER_SHOW_BLIZZARD_QUEST_TIMER'] = "Chronomètre des quêtes de Blizzard",
    ['TRACKER_SHOW_BLIZZARD_QUEST_TIMER_DESC'] = "Active l'affichage du chronomètre des quêtes par défaut.",
