QuestieLocale.locale['deDE'] = {
    ...
    ['TRACKER_STICKY_DURABILITY_FRAME'] = "Haltbarkeitsanzeige am Tracker",
    ['TRACKER_STICKY_DURABILITY_FRAME_DESC'] = "Wenn aktiv wird die Haltbarkeitsanzeige an der linken Seite des Trackers positioniert.",
    ['TRACKER_HIDE_IN_COMBAT'] = "Minimiere Tracker im Kampf",
    ['TRACKER_HIDE_IN_COMBAT_DESC'] = "Wenn aktiv wird der Tracker im Kampf automatisch minimiert.",
