...
L["Chat History"] = "對話記錄"
L["Chat Output"] = "聊天輸出"
L["Check these to only have the filter active in certain difficulties. If none are checked, it is active in all difficulties."] = "選中這些項目會使得過濾器僅在當前難度下啟用. 如果沒有選中任意一個, 將會在全部難度中啟用."
...
L["Player in Vehicle"] = "玩家在載具"
L["Player is Resting"] = "玩家在休息"
L["Player Out of Combat"] = "玩家戰鬥外"
L["Player Out of Vehicle"] = "玩家不在載具"
L["Player Power"] = "玩家能量"
